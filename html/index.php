...
<body>
  <div class="content">
    ...
    <div class="table" style="font-family: Rockwell; font-size: 40px; margin-left: auto; margin-right: auto;">
      ...
      <input type="number" name="itemQuantity" id="itemQuantity" placeholder="1" />
      ...
      <a href=cartadding.php?id=' . $row['item_name'] . '&price=' . $row['item_price'] . '&quantity=S' . 'itemQuantity' . ' class="btn">Add To Cart</a>
      </td>';
              echo '</tr>';
            }
          } else {
